	  ...
	  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
	    <ul class="navbar-nav">
	          ...
	          <li class="nav-item active">
	            <a class="nav-link" href="car.php">Cars<span class="sr-only">(current)</span></a>
	          </li>
	          <li class="nav-item">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding-left: 100px; padding-top: 10px;">
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      <li class="nav-item">
	        <a class="nav-link" href="car.php">All Cars</a>
	      </li>
	...
	<div class="modal fade" id="signupModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered" role="document">
		...
		<div class="container" style="margin-top: 50px; width: 950px; height: 2000px; text-align: center;">
		  ...
		  $sql = "SELECT * FROM cars WHERE SUBSTRING(lower(name), LOCATE(' ', name)+1) = '$car_name' || SUBSTRING(upper(name), LOCATE(' ', name)+1) = '$car_name' || SUBSTRING(name, LOCATE(' ', name)+1) = '$car_name' || name = '$car_name'";
		  $result = mysqli_query($conn, $sql);

		  if (mysqli_num_rows($result) > 0) {
		  	  $count = 0;
		      // output data of each row
		      echo '<h1 style="color: teal;"><b>A Car For Every Need!</b></h1>';
		        ...
		        echo  '<div class="card" style="width: 280px; float: left; margin-right: 25px; margin-bottom: 25px;">'
		        	    ...
		        	    .'<div class="card-body">'
		        	      ...
		        	      .'<p class="card-text">'
		        	 		...
		        	 		.'<br>'
		        	 		.'<br>'
		        			.'<button type="button" class="btn btn-warning" onclick=set_num("'.$reg_no[$count].'")>BOOK NOW</button>'
		        	      .'</p>'
		        	    .'</div>'
		        	  .'</div>';
		        $count++;
		      ...
		      echo "<h3>Sorry! No Car Found</h3>";
		  }
		  ?>
		</div>
		<form action="book_now.php" method="post" id="book_form">
